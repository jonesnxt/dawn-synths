...
swing_one_knob = analogio.AnalogIn(board.A5)
...
swing_three_knob = analogio.AnalogIn(board.A3)
...
while True:
    ...
    nanoseconds_per_subtempo_one_flat_beat = (
        nanoseconds_per_beat * current_subtempo_one
        if current_subtempo_one < 0
    ...
    subtempo_one_out = should_subtempo_one_be_high
